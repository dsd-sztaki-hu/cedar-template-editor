...
gulp.task('replace-url', function (done) {
  gulp.src(['app/config/src/url-service.conf.json'])
      ...
      .pipe(replace('CEDAR_FRONTEND_JSON_DIFF_PREVIEW_URL', CEDAR_FRONTEND_JSON_DIFF_PREVIEW_URL))
...
let envConfig = {
  ...
  'CEDAR_FRONTEND_JSON_DIFF_PREVIEW_URL': null
};
console.log();
console.log();
console.log(
...
var CEDAR_FRONTEND_JSON_DIFF_PREVIEW_URL = envConfig['CEDAR_FRONTEND_JSON_DIFF_PREVIEW_URL'];
...
console.log("CEDAR_FRONTEND_JSON_DIFF_PREVIEW_URL", CEDAR_FRONTEND_JSON_DIFF_PREVIEW_URL)
